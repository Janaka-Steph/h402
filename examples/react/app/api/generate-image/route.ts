...
export async function GET(request: NextRequest) {
  ...
  // The middleware will handle the 402 payment flow
  // If we reach this point, it means the payment has been verified
  // The base64Payment will be automatically included by the middleware
  if (!base64Payment) {
    console.warn("No payment information found, but middleware should have handled this");
  }
