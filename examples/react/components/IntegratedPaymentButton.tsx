...
function ConnectedPaymentButton({
  ...
  return (
    <div className="flex flex-col w-full">
      <button
        className={`payment-button ${isProcessing ? 'payment-button-processing' : ''} ${className}`}
        onClick={handleClick}
        disabled={isDisabled}
      >
        <div className="flex items-center justify-center">
          {isProcessing && (
            <svg className="payment-button-spinner" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24">
